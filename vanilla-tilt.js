	...
	class t {
		...
		getElementListener() {
			...
			if ("string" == typeof this.settings["mouse-event-element"]) {
				let t = document.querySelector(this.settings["mouse-event-element"]);
				if (t) return t;
			}
		...
		onDeviceOrientation(t) {
			...
			let e = this.settings.gyroscopeMaxAngleX - this.settings.gyroscopeMinAngleX,
			...
			null !== this.updateCall && cancelAnimationFrame(this.updateCall),
				(this.event = { clientX: l / s + this.left, clientY: a / n + this.top }),
