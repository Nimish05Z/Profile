...
function visualmode() {
    document.body.classList.toggle("light-mode"),
        document
            .getElementById("labelforsound")
            .classList.toggle("invertsoundlabel"),
        document
...
window.addEventListener("scroll", () => {
    ...
    sections.forEach((t) => {
        let l = t.offsetTop;
        t.clientHeight, pageYOffset >= l - 500 && (e = t.getAttribute("id"));
    }),
    ...
    console.log(
        "%c Designed and Developed by Ram nathawat ",
